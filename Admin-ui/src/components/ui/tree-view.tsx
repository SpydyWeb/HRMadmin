...
import { BiBox, BiChevronDown, BiChevronRight, BiFolder, BiSearch } from "react-icons/bi";
...
const defaultIconMap: TreeViewIconMap = {
  ...
  folder: <BiFolder className="h-4 w-4 text-neutral-900/80 dark:text-neutral-50/80" />,
};
        ...
        <div>
          <div
            ...
            className={`select-none cursor-pointer ${
              isSelected ? `bg-orange-100 ${selectionStyle}` : "text-neutral-950 dark:text-neutral-50"
            } px-1`}
